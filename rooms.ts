...
export const rooms: { [roomId: string]: Room } = {
    bar: {
        ...
        objects: [
            { x: 1, y: 1, offset: { x: 130, y: 311 }, url: "table.svg" },
            { x: 1, y: 2, offset: { x: 170, y: 291 }, url: "table.svg" },
...
//            { x: 4, y: 8 },
        ...
        doors: {
            ...
            ladder: { x: 0, y: 0, direction: "right", target: { roomId: "radio", doorId: "door1" } },
    ...
    basement: {
	    ...
	    gikopoi: {x: 5, y: 1, direction: "down", target: null}
        },
        streamSlotCount: 3,
    ...
    takadai: {
        ...
        doors: {
            ...
            right: { x: 5, y: 0, direction: "up", target: { roomId: "kaidan", doorId: "top_right" } },
        },
        streamSlotCount: 6,
    },
    silo: {
    ...
    yoshinoya: {
        ...
        doors: {
            ...
            door: { x: 11, y: 7, direction: "left", target: { roomId: "bar_giko_square_v2", doorId: "yoshinoya" } }
    ...
    bar_giko: {
        ...
        forbiddenMovements: [],
        doors: {
            stairs: { x: 7, y: 19, direction: "right", target: { roomId: "bar_giko_square_v2", doorId: "bar_giko" } },
    ...
    radio_room1: {
        ...
        forbiddenMovements: [],
        doors: {
            right: { x: 6, y: 6, direction: "left", target: { roomId: "bar_st", doorId: "bar_roof" } },
        },
        streamSlotCount: 0,
    },
    radio_room2: {
    ...
    radio: {
        ...
        doors: {
            ...
            door1: { x: 0, y: 2, direction: "right", target: { roomId: "bar", doorId: "ladder" } },
	...
	worldSpawns: [
	{x: 1, y: 9, direction: "down", target: null},
	],
        objects: [
        ...
        doors: {
            ...
            left_middle: { x: 0, y: 7, direction: "right", target: { roomId: "bar_giko_square_v2", doorId: "up" } },
...
temple: {
   ...
   library: {
    ...
    nerd_office: {
        ...
        forbiddenMovements: [],
        doors: {
            door: { x: 9, y: 0, direction: "up", target: { roomId: "bar_giko_square_v2", doorId: "office" } },
    ...
    meganeya: {
        ...
        forbiddenMovements: [],
        doors: {
            top_right: { x: 14, y: 15, direction: "down", target: { roomId: "bar_giko_square_v2", doorId: "bottom_left" } },
    ...
    kyougijou: {
        ...
        forbiddenMovements: [],
        doors: {
            door: { x: 8, y: 2, direction: "left", target: { roomId: "bar_giko_square_v2", doorId: "very_left" } },
    ...
    karaoke_box: {
        ...
        doors: {
            door: { x: 0, y: 0, direction: "right", target: { roomId: "bar_giko_square", doorId: "up" } },
        },
        streamSlotCount: 3
    },
...
vapor_mall:{
    ...
    blockHeight: 35.5,
    blockWidth: 71.5,
    originCoordinates: { x: 1, y: 411 },
    spawnPoint: "right_top",
    backgroundImageUrl: "rooms/vapor_mall/mall.svg",
    backgroundColor: "#2EB3AC",
    objects: [
        { x: 5, y: 0, offset: { x: 189, y: 447 }, url: "barrier.svg" },
        { x: 6, y: 0, offset: { x: 225, y: 465 }, url: "barrier.svg" },
        { x: 9, y: 4, offset: { x: 465, y: 448 }, url: "ctrl.svg" },
        { x: 9, y: 1, offset: { x: 320, y: 417 }, url: "fountain.svg" },
        { x: 9, y: 8, offset: { x: 605, y: 179 }, url: "palm_(fresh_prince_of_bel_air).svg" },
        { x: 2, y: 1, offset: { x: 36, y: 232 }, url: "palm_(tall_king).svg" },
        
        { x: 9, y: 5, offset: { x: 501, y: 429 }, url: "space_bar_near_end.svg" },
        { x: 9, y: 6, offset: { x: 536, y: 410 }, url: "space_bar_middle.svg" },
        { x: 9, y: 7, offset: { x: 572, y: 392 }, url: "space_bar_middle.svg" },
        { x: 9, y: 8, offset: { x: 608, y: 376 }, url: "space_bar_far_end.svg" },

        { x: 9, y: 1, offset: { x: 787, y: 36 }, url: "music_player.svg" },
       // { x: 9, y: 8, offset: { x: 500, y: 376 }, url: "space_bar.svg" },

        { x: 2, y: 6, offset: { x: 501, y: 35.5 }, url: "wall_foreground.svg" },
    ],
    sit: [
        { x: 9, y: 4 },
        { x: 9, y: 5},
    ...
    forbiddenMovements: [
        { xFrom:  9, yFrom:  9, xTo:  9, yTo:  8 },
    ],
    doors: {
        right_top: { x: 5, y: 10, direction:null, target: { roomId: "bar_giko_square_v2", doorId: "mall_left_top" } },
        right_bottom: { x: 6, y: 10, direction:null, target: { roomId: "bar_giko_square_v2", doorId: "mall_left_bottom" } },
        helios: { x: 2, y: 8, direction:null, target: { roomId: "vapor_mall", doorId: "music_player_spawn" } },
        music_player_spawn: { x: 2, y: 22, direction:null, target: null},
        music_player_exit: { x: 2, y: 21, direction:null, target: { roomId: "vapor_mall", doorId: "right_top" } },
    },
    streamSlotCount: 8,
},
bar_giko_square_v2:{
    id: "bar_giko_square_v2",
    group: "agora_road",
    scale: 1,
    size: { x: 24, y: 27 },
    originCoordinates: { x: -201, y: 640 },
    spawnPoint: "up",
    backgroundImageUrl: "rooms/bar_giko_square_v2/background.svg",
    objects: [
        { x:  9, y:  5, offset: { x:    157, y:  543 }, url: "mall_arch_back.svg" },
        { x:  14, y:  0, offset: { x:    197, y:  541 }, url: "mall_arch_front.svg" },
        
        { x:  0, y:  9, offset: { x:    160, y:  199 }, url: "koban_with_poster.svg" },
        { x: 15, y: 23, offset: { x: 1319, y:  259 }, url: "bar_giko_with_roof.svg" },
        { x: 16, y: 22, offset: { x: 1320, y:  438 }, url: "bar_giko_sign.svg" },
        { x: 11, y: 16, offset: { x:  820, y:  422 }, url: "fountain.svg" },
        { x:  6, y: 22, offset: { x:  919, y:  232 }, url: "bench.svg" },
        { x: 19, y:  14, offset: { x:  1149, y:  491 }, url: "street_light_left.svg" },
        { x: 14, y: 22, offset: { x: 1270, y:  226 }, url: "street_light_left.svg" },
        { x:  14, y:  9, offset: { x:  750, y:  491 }, url: "street_light_right.svg" },
    ],
    sit: [
        { x:  6, y: 22 },
        { x:  7, y: 22 },
    ...
    forbiddenMovements: [],
    doors: {
        up: { x: 11, y: 26, direction: "down", target: { roomId: "densha", doorId: "left_middle" } },
        bar_giko: { x: 17, y: 22, direction: "down", target: { roomId: "bar_giko", doorId: "stairs" } },
        yoshinoya: { x: 4, y: 20, direction: "right", target: { roomId: "yoshinoya", doorId: "door" } },
        left: { x: 0, y: 17, direction: "right", target: { roomId: "monachat", doorId: "door" } },
        right: { x: 23, y: 16, direction: "left", target: { roomId: "konbini", doorId: "door" } },
        office: { x: 5, y: 22, direction: "down", target: { roomId: "nerd_office", doorId: "door"} },
        bottom_left: {x: 17, y: 9, direction: "up", target: {roomId: "meganeya", doorId: "top_right"} },
        very_left: {x: 0, y: 8, direction: "right", target: { roomId: "kyougijou", doorId: "door"} },
        mall_left_top: {x: 11, y: 0, direction: "down", target: { roomId: "vapor_mall", doorId: "right_top"} },
        mall_left_bottom: {x: 12, y: 0, direction: "down", target: { roomId: "vapor_mall", doorId: "right_bottom"} },
    },
    streamSlotCount: 0,
}
    };

// HERE WE BEGIN TO FIX ANNUAL EVENTS
// ARCHPOI 20231115
...
dynamicRooms.push({
    ...
    build: (currentAnnualEvents: string[]) =>
    {
        ...
        return {
            ...
            forbiddenMovements: [],
            doors: {
                door: { x: 6, y: 6, direction: "left", target: { roomId: "bar_giko_square_v2", doorId: "left" } },
